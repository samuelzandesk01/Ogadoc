...
update_option('_ff_fluentform_pro_license_key','6d450cd5-b522-4b0a-8925-966afc4a6872');
update_option('_ff_fluentform_pro_license_status','valid');
update_option('_ff_signature_license_key','6d450cd5-b522-4b0a-8925-966afc4a6872');
update_option('_ff_signature_license_status','valid');

define('FLUENTFORMPRO', true);
define('FLUENTFORMPRO_VERSION', '5.0.10');
